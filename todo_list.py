...
class TaskManager:
    ...
    def save_tasks(self):
        try:
            ...
            print(f"Error al guardar. Revise la existencia del archivo task.json. Error {e}")
                
    def add_task(self, title, description):
        new_task=Task(title.upper(), description)
        self.tasks.append(new_task)
        self.save_tasks()
        print(f"Tarea: {title} -> guradada con exito.")
...
"""
Creado por María Cao como tarea final
